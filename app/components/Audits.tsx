          ...
          >
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2 mb-2">
                {audit.pro_bono && (
                  <span className="text-xs sm:text-sm bg-green-500/20 text-green-300 px-2 sm:px-3 py-1 rounded-full whitespace-nowrap">
                    Pro Bono
                  </span>
                )}
                <span className="text-xs sm:text-sm bg-cyan-500/20 text-cyan-300 px-2 sm:px-3 py-1 rounded-full whitespace-nowrap">
                  {audit.type}
                </span>
              </div>
            </div>
